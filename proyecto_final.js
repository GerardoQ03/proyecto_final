...
if(edad < 18){
    alert("Lo sentimos debe ser mayor de edad.")
}else{
    ...
    cantidad_hijos_numero = cantidad_hijos_numero * hijos_recargo
    hijos_recargo = precio_base * cantidad_hijos_numero
    recargo_total = recargo_total + hijos_recargo
    }
